...
public class modifySesionServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (customerBean == null || customerBean.getEmailUser().equals("")) {
			RequestDispatcher dispatcher = request
					.getRequestDispatcher("/mvc/view/userNotFound.html");
			...
			int placesLeft = Integer.parseInt(request
					.getParameter("numberOfPlacesLeft"));
			...
			SimpleDateFormat formatter6 = new SimpleDateFormat(
					"dd-MM-yyyy HH:mm");
			String stringDate = day + "-" + month + "-" + year + " " + hour
					+ ":" + minutes;
			...
			if (date.compareTo(new java.util.Date()) > 0) {
				...
				RequestDispatcher dispatcher = request
						.getRequestDispatcher("/mvc/view/errorAdingSesion.html");
				dispatcher.include(request, response);
			}

			RequestDispatcher dispatcher = request
					.getRequestDispatcher("/mvc/view/listSesions.jsp");
			dispatcher.include(request, response);
		}
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		if (customerBean == null || customerBean.getEmailUser().equals("")) {
			...
			RequestDispatcher dispatcher = request
					.getRequestDispatcher("/mvc/view/modifySesion.jsp");
			dispatcher.include(request, response);
		}
	}
}
