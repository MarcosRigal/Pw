...
/**
 * Clase modifySesionServlet para modificar una sesión del sistema
...
public class modifySesionServlet extends HttpServlet {
  ...
  protected void doPost(
    ...
    if (customerBean == null || customerBean.getEmailUser().equals("")) {
      ...
      int placesLeft = Integer.parseInt(
        request.getParameter("numberOfPlacesLeft")
      );
