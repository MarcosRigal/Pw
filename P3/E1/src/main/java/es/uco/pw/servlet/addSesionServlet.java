...
public class addSesionServlet extends HttpServlet {
  ...
  protected void doPost(
    ...
    if (customerBean == null || customerBean.getEmailUser().equals("")) {
      ...
      if ((date.compareTo(new java.util.Date())>0)&&((spectacle.getType().equals("Single") && numberOfSesionsAfter < 2)||(spectacle.getType().equals("Multiple"))||(spectacle.getType().equals("Season")))) {
         System.out.println(spectacle.getType());
        ...
        if ((spectacle.getType().equals("Single"))||(spectacle.getType().equals("Multiple"))) {			
        	sesionManager.registerSesion(sesion);
		}
        else{
        	String parameterNumberOfSesions = request.getParameter("numberOfSesions");
