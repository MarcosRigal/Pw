	...
	<div id="preloader">
		...
		<%
			...
			if (customerBean != null) {
				...
				SpectacleDTO spectacle = spectacleManager.findSpectacle(Integer
						.parseInt(search));
				ArrayList<ReviewDTO> reviews = reviewManager
						.searchSpectaclesReview(spectacle.getSpectacleId());
		%>
			...
			<div class="row ipad-width2">
				<div class="col-md-9 col-sm-12 col-xs-12">
					<h1 style="color: white">
						Reviews de
						<%=spectacle.getTitle()%></h1>
					<br></br>
					<div class="row">
						<%
							for (int i = 0; i < reviews.size(); i++) {
									if (reviews.get(i).getEmail()
											.equals(customerBean.getEmailUser())) {
						...
						<div class="col-md-12">
							<div class="ceb-item-style-2">
								...
								+ "/5"%></p>
									...
									<hr>
									<a
										href=<%="voteReview?reviewId="
								+ reviews.get(i).getReviewId() + "&choice=1"%>
										class="btn"
										style="background-color: #091A2C; color: white; border: none">
										<i class="fa fa-thumbs-up fa-lg" aria-hidden="true"></i>
									</a> <span><%=reviews.get(i).getLike()%></span> &nbsp; <a
										href=<%="voteReview?reviewId="
								+ reviews.get(i).getReviewId() + "&choice=2"%>
										class="btn"
										style="background-color: #091A2C; color: white; border: none">
										<i class="fa fa-thumbs-down fa-lg" aria-hidden="true"></i>
									</a> <span><%=reviews.get(i).getDislike()%></span>
								</div>
							</div>
						</div>
						<%
