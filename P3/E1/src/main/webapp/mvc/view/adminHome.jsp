	...
	<div id="preloader">
		...
		<%
			...
			if (customerBean != null
					&& customerBean.getTypeUser().equals("Admin")) {
		%>
	</div>
	<!--end of preloading-->
	<!-- BEGIN | Header -->
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="ceb-item-style-2">
								<div class="ceb-infor">
									<h2>
										<a href="#"><%=users.get(i).getName() + " "
							+ users.get(i).getSurname()%></a>
									</h2>
									<p />
									<p><%="Rol: " + users.get(i).getType()%></p>
									<p><%="Fecha de registro: "
							+ formatter5.format(users.get(i).getRegisterDate())%></p>
									<p><%="Último inicio de sesión: "
							+ formatter5.format(users.get(i).getLastLogin())%></p>
								</div>
							</div>
						</div>
						<%
