	...
	<div id="preloader">
		...
		<%
			...
			if (customerBean != null) {
				...
				SesionDTO sesion = sesionManager.findSesion(Integer
						.parseInt(search));
		%>
				...
				<div class="col-md-3 col-sm-12 col-xs-12">
					<div class="user-information">
						...
						<%
								...
								spectacle = spectacleManager.findSpectacle(sesion
										.getSpectacleId());
						%>
					</div>
				</div>
					...
					<div class="form-style-1 user-pro">
						<form method="post" action="modifySesion" class="user">
							...
							<div class="row">
								...
								<div class="col-md-6 form-it">
									<label>Nº de plazas libres</label> <input type="number"
										name="numberOfPlacesLeft" min="0"
										max=<%=spectacle.getPlaces()%>
										placeholder=<%=sesion.getPlacesLeft()%> required="required" />
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 form-it">
									<label>Espectáculo</label> <select name="sesionId">
