...
<div class="landing-hero">
    ...
    <br></br>
    <a class="redbtn signupLink" href="#" style="color:white">Registrate</a>
    <a class="redbtn loginLink" href="#" style="color:white;margin-left: 4em">Inicia sesión</a>
    <br></br>
    <br></br>
</div>
<!-- footer section-->
...
<br></br>
	<div class="container">
		<div class="flex-parent-ft">
			...
			<br></br>
				<h4>Contacto</h4>
				 <p>Av. de Medina Azahara, 5,<br>14071 Córdoba</p>
				<p>Llámanos: <a href="#">(+34) 957 218 000</a></p>
			</div>
		</div>
	</div>
</footer>
